<!-- this will serve as the layout of the file -->
...
<template>
	<section class="w-2/5 ml-2 font-basic" id="criminalProfile">
		...
		<!-- <p class="font-basic tracking-normal text-2xl mb-4 mt-4 font-normal text-black mr-2">
			Criminal Profile of {{ criminalsInfo }}
		</p> -->
		<div class="bg-white px-8 py-8 pt-4">
			<div class="text-center">
				<div id="avatar" class="inline-block mb-6" >
					...
					<slot name="crimes"></slot>
					<!-- <crimes-list :criminals="crimes"></crimes-list> -->
					<div class="w-full flex justify-between">
						<!-- <slot name="badges"></slot> -->
						<button class="w-full bg-green-theme p-3 text-white mt-4 ml-2 hover:bg-green-second" href="/criminal/" >View Full Profile</button>
