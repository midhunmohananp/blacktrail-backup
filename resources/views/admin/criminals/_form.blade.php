...
<div class="mb-2">
	...
	<input v-model="form.alias"  name="first_name" type="text"  value="{{  old('alias') }}" class="bg-grey-lighter w-3/4 mb-2 p-2 leading-normal" id="pin" name="pin" autocomplete="name" placeholder="Alias" required>
</div>	

<div class="mb-2">
	<label for="name" class="block uppercase tracking-wide text-black-v2 text-xs font-bold mb-2">If found, Report this to:
	</label>
	<select v-model="form.contact_person"  name="country"  class="bg-grey-lighter w-3/4 mb-2 p-2 leading-normal" >
...
<div class="mb-2">
	...
	<input v-model="form.contact_number" name="phone_number" type="text"  class="bg-grey-lighter w-3/4 mb-2 p-2 leading-normal" id="pin" name="pin" autocomplete="name" placeholder="Alias" required>
</div>	

<div class="mb-2">
	<label for="name" class="block uppercase tracking-wide text-black-v2 text-xs font-bold mb-2">Initial Bounty</label>
	<input v-model="form.bounty" name="number" type="text" class="bg-grey-lighter w-3/4 mb-2 p-2 leading-normal" id="pin" name="pin" autocomplete="name" placeholder="Alias" required>
</div>	
